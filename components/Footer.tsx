  ...
  return (
    <>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-4 justify-between">
          <div className="flex flex-col w-[45%]">
            ...
            <div className=" flex gap-2 lg:gap-4 justify-center items-center mt-2 lg:mt-4">
              <SocialIcon
                className=""
                href="https://www.facebook.com/sharer/sharer.php?u=http%3A//localhost"
                network="facebook"
              />
              <SocialIcon
                className=""
                href="https://twitter.com/intent/tweet?url=http://localhost&text=Westeros%20Coffee"
                network="x"
              />
              <SocialIcon
                className=""
                href="https://pinterest.com/pin/create/button/?url=http://localhost&media=&description=Westeros%20Coffee"
                network="pinterest"
              />
              <SocialIcon
                className=""
                href="https://www.linkedin.com/shareArticle?mini=true&url=http%3A//localhost"
                network="linkedin"
              />
              <SocialIcon
                className=""
                href="mailto:info@example.com?&subject=&cc=&bcc=&body=http://localhost%0AWesteros%20Coffee"
                network="email"
              />
            </div>
          </div>
          <div className="w-[45%] ">
            <h2 className="text-primary text-center text-xl lg:text-2xl">
              Hire me
            </h2>
            <p>
              Do you like my work?? I am looking to be a valuable teammember.
            </p>
      ...
      <p className="text-center text-base">
        Legal Disclaimer: This is not a real company. This site is part of a
        developer profile.
      </p>
      <p className="text-center text-base">
