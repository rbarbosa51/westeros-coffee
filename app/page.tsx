...
export default function Home() {
  return (
    <div>
      <div className="hero h-1/2 glass my-4">
        <div className="hero-content text-center">
          <div className="max-w-xl">
            <h1 className="text-5xl font-bold text-primary">Welcome to our Coffee Store</h1>
            <p className="py-6">You came to the right place. Enjoy the absolute best coffee Westeros has to offer. Our selection of award winning coffee products, will make you appreciate the distinction between our product and the rest.</p>
            <button className="btn btn-primary"><Link href={'/coffee'}>Get Started</Link></button>
          </div>
        </div>
      </div>
      {/* Awards */}
      <div className="card w-full glass shadow-xl image-full mb-4 lg:mb-8">
        <figure><img src="/awards.jpeg" alt="Awards" className="aspect-square w-96"/></figure>
      ...
      {/* Shipping */}
      <div className="card w-full glass card-side shadow-xl">
      <figure><img src="/shipping.jpeg" alt="Awards" className="aspect-square w-96"/></figure>
      <div className="card-body">
        <h2 className="card-title text-4xl text-accent">Shipping</h2>
        <p className="text-lg">We now provide expedited shipping via Dragon. You can now get your favorite coffee even faster.</p>
